...
describe('test based on examples', () => {
  ...
  describe('1.13.2 iron shovel', () => {
    const Item = require('reinarpg-item')('1.13.2')
...
describe('get Item.enchants', () => {
  ...
  describe('1.12.2 test', () => {
    const Item = require('reinarpg-item')('1.12.2')
  ...
  describe('bedrock_1.17.10 test', () => {
    const Item = require('reinarpg-item')('bedrock_1.17.10')
  ...
  describe('bedrock_1.19.1 test', () => {
    const Item = require('reinarpg-item')('bedrock_1.19.1')
...
describe('item.spawnEggMobName', () => {
  describe('1.8.9 test', () => {
    it('zombie egg', () => {
      const Item = require('reinarpg-item')('1.8.9')
  ...
  describe('1.11.2 test', () => {
    it('zombie egg', () => {
      const Item = require('reinarpg-item')('1.11.2')
